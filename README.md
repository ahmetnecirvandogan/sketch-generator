...
│  → dataset/renders/, dataset/depth/, dataset/normals/            │
├──────────────────────────────────────────────────────────────────┤
...
| `dataset/depth/`, `dataset/normals/` | Per-frame `.npy` geometry buffers |
| `dataset/masks/` | Per-frame cloth alpha masks for sketch segmentation |
